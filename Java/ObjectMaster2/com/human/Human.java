...
public class Human {
	...
	public void attack(Human target) {
		System.out.println(this.getPlayerName()+" a atacado a "+target.getPlayerName()+"!");
		target.setHealth(target.getHealth() - this.strength);		if (target.getHealth() < 0) {
	...
	public void setAtributes(int health ,int strength, int intelligence, int stealth) {
		this.health = health;
